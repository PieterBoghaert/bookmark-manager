<div class="bg-white dark:bg-gray-800 rounded-xl shadow-soft py-10 px-8 flex flex-col gap-8">
    ...
    <div>
        <h1 class=" text-gray-900 dark:text-white mb-1.5">Log in to your account</h1>
    ...
    <div class="flex flex-col gap-3 text-center">
        <p>Forgot password? <a href="/forgot-password" wire:navigate>Reset it</a></p>
