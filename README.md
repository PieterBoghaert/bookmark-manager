...
This app should be created in Laravel Livewire
I would like to use the latest stable version of Tailwind css
3 main components: a sidebar with a list of checkbox tags, (a header with a search field, a bookmark button, a profile picuture) and the 3d an overview of all the bookmarks with a single-bookmark-component

There should also be a register and login component, and you have to be logged in to see the rest of the components.

There should a light and darkmodus

Use the view transition API as well to have a nicer effect when filtering
